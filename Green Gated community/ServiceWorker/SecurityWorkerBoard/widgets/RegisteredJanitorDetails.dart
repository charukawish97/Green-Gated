...
import 'package:flutter_hr_management/pages/ViewAllPages/ViewAllpagesScreen.dart';

import '../../../ViewAllPages/viewallboard/FullviewDetails.dart';

class RegJanitorDetails extends StatefulWidget {
  @override
  _RegJanitorDetailsState createState() => _RegJanitorDetailsState();
}

class _RegJanitorDetailsState extends State<RegJanitorDetails> {
  @override
              ...
              GestureDetector(
                onTap: () {
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(builder: (context) => ViewAllPages()),
                  );
                },
                child: Container(
                  decoration: BoxDecoration(
